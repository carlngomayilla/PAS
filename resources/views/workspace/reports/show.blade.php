            ...
            <section class="app-screen-block rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                @if ($canManageMeetingDecisions)
                    <form class="mt-5 form-shell border-t border-slate-200 pt-5 dark:border-slate-700" method="POST" action="{{ route('workspace.reports.decisions.store', $report) }}">
                        ...
                        <div class="form-grid">
                            ...
                            <div><label for="decision_due_at">Echeance</label><input id="decision_due_at" name="due_at" type="date" value="{{ old('due_at') }}">@error('due_at')<x-form.error :message="$message" />@enderror</div>
                        </div>
                ...
                <div class="mt-5 overflow-x-auto">
                    <table class="min-w-full text-left text-sm">
                        <thead class="border-b border-slate-200 text-xs uppercase text-slate-500 dark:border-slate-700 dark:text-slate-400"><tr><th class="px-3 py-3">Decision</th><th class="px-3 py-3">Responsable</th><th class="px-3 py-3">Echeance</th><th class="px-3 py-3">Etat</th><th class="px-3 py-3">Suivi</th></tr></thead>
