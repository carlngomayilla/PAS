...
@section('content')
    ...
    <section class="ui-card mb-3.5">
        ...
        <div class="mt-4 grid gap-3 [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))]">
            ...
            <article class="ui-card !mb-0"><strong>KPI et statistiques</strong><p class="mt-2 text-slate-600">Registre pilote des indicateurs consolides, seuils de lecture et profils cibles du reporting officiel.</p></article>
            ...
            <article class="ui-card !mb-0"><strong>Simulation</strong><p class="mt-2 text-slate-600">Comparaison avant application des impacts workflow / base officielle / cloture des actions.</p></article>
