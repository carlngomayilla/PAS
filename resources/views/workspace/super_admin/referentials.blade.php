    ...
    <section class="showcase-panel mb-4">
        <form method="POST" action="{{ route('workspace.super-admin.referentials.update') }}" class="form-shell">
            ...
            <div class="form-section">
                ...
                <p class="form-section-subtitle">Les codes techniques restent fixes pour conserver la compatibilite des calculs. Seuls les libellés de l interface sont pilotables.</p>
                <div class="form-grid">
                    <div>
            ...
            <div class="form-section">
                <h2 class="form-section-title">Suggestions d'unites Indicateur de performance</h2>
