...
@section('content')
    ...
    <div class="app-screen-flow">
        ...
        <section class="app-screen-block" aria-labelledby="directions-list-title">
            <form method="GET" action="{{ route('workspace.referentiel.directions.index') }}" class="grid gap-3 rounded-lg border border-slate-200 bg-slate-50/85 p-3 md:grid-cols-2 xl:grid-cols-5 dark:border-slate-700 dark:bg-slate-900/70" data-auto-filter-form>
