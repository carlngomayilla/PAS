...
Route::middleware(['auth:sanctum', EnsurePasswordIsFresh::class])->group(function (): void {
    ...
    Route::get('actions/{action}/weeks', [ActionController::class, 'weeks'])
        ->name('actions.weeks');
    Route::post('actions/{action}/weeks/{actionWeek}/submit', [ActionController::class, 'submitWeek'])
        ->name('actions.weeks.submit');
    Route::post('actions/{action}/close', [ActionController::class, 'close'])
        ->name('actions.close');
    Route::post('actions/{action}/review', [ActionController::class, 'review'])
        ->name('actions.review');
    Route::post('actions/{action}/review-direction', [ActionController::class, 'reviewDirection'])
        ->name('actions.review-direction');
    Route::post('actions/{action}/comments', [ActionController::class, 'comment'])
        ->name('actions.comments');
    Route::get('actions/{action}/logs', [ActionController::class, 'logs'])
        ->name('actions.logs');
