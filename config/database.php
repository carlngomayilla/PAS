    ...
    */
    ...
    'redis' => [
        ...
        'cache' => [
            ...
            'prefix' => env('REDIS_CACHE_PREFIX', Str::slug((string) env('APP_NAME', 'laravel')).'-cache-'),
            'max_retries' => env('REDIS_MAX_RETRIES', 3),
            'backoff_algorithm' => env('REDIS_BACKOFF_ALGORITHM', 'decorrelated_jitter'),
            'backoff_base' => env('REDIS_BACKOFF_BASE', 100),
            'backoff_cap' => env('REDIS_BACKOFF_CAP', 1000),
        ...
        'sessions' => [
            ...
            'prefix' => env('REDIS_SESSION_PREFIX', Str::slug((string) env('APP_NAME', 'laravel')).'-sessions-'),
            'max_retries' => env('REDIS_MAX_RETRIES', 3),
            'backoff_algorithm' => env('REDIS_BACKOFF_ALGORITHM', 'decorrelated_jitter'),
            'backoff_base' => env('REDIS_BACKOFF_BASE', 100),
            'backoff_cap' => env('REDIS_BACKOFF_CAP', 1000),
        ...
        'queue' => [
            ...
            'prefix' => env('REDIS_QUEUE_PREFIX', Str::slug((string) env('APP_NAME', 'laravel')).'-queue-'),
            'max_retries' => env('REDIS_MAX_RETRIES', 3),
            'backoff_algorithm' => env('REDIS_BACKOFF_ALGORITHM', 'decorrelated_jitter'),
            'backoff_base' => env('REDIS_BACKOFF_BASE', 100),
            'backoff_cap' => env('REDIS_BACKOFF_CAP', 1000),
        ...
        'horizon_meta' => [
            'url' => env('REDIS_HORIZON_URL', env('REDIS_QUEUE_URL', env('REDIS_URL'))),
            ...
            'port' => env('REDIS_HORIZON_PORT', env('REDIS_QUEUE_PORT', env('REDIS_PORT', '6379'))),
            'database' => env('REDIS_HORIZON_DB', '4'),
            'prefix' => env('REDIS_HORIZON_PREFIX', Str::slug((string) env('APP_NAME', 'laravel')).'-horizon-'),
            'max_retries' => env('REDIS_MAX_RETRIES', 3),
            'backoff_algorithm' => env('REDIS_BACKOFF_ALGORITHM', 'decorrelated_jitter'),
            'backoff_base' => env('REDIS_BACKOFF_BASE', 100),
            'backoff_cap' => env('REDIS_BACKOFF_CAP', 1000),
