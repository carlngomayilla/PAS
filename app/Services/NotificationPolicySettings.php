...
class NotificationPolicySettings
{
    ...
    public function eventDefinitions(): array
    {
        return [
            ...
            'deadline_extension_requested' => ['group' => 'Modifications d’action', 'label' => 'Demande de modification', 'description' => 'Notification envoyée au chef de service lors d’une nouvelle demande du RMO.'],
            'deadline_extension_sciq_reviewed' => ['group' => 'Modifications d’action', 'label' => 'Décision hiérarchique', 'description' => 'Notification après décision du chef de service ou du directeur.'],
            'deadline_extension_dg_decided' => ['group' => 'Modifications d’action', 'label' => 'Décision finale DG', 'description' => 'Notification après décision finale et application automatique des paramètres approuvés.'],
            'meeting_scheduled' => ['group' => 'Réunions', 'label' => 'Réunion programmée', 'description' => 'Notification envoyée aux participants lors de la programmation d une réunion.'],
            'meeting_reminder' => ['group' => 'Réunions', 'label' => 'Rappel de réunion', 'description' => 'Rappel automatique envoyé avant une réunion programmée.'],
            'meeting_postponed' => ['group' => 'Réunions', 'label' => 'Réunion reportée', 'description' => 'Notification envoyée aux participants lors du report d une réunion.'],
            'meeting_cancelled' => ['group' => 'Réunions', 'label' => 'Réunion annulée', 'description' => 'Notification envoyée aux participants lors de l annulation d une réunion.'],
            'meeting_minutes_published' => ['group' => 'Réunions', 'label' => 'PV disponible', 'description' => 'Diffusion du procès-verbal aux membres et aux services de contrôle.'],
            'meeting_decision_assigned' => ['group' => 'Réunions', 'label' => 'Décision à suivre', 'description' => 'Notification envoyée au responsable d une décision issue de réunion.'],
    ...
    private function eventTemplateDefaults(): array
    {
        return [
            ...
            'deadline_extension_requested' => ['title' => 'Demande de modification', 'message' => '{actor_name} demande une modification de l’action « {action_label} ».', 'channels' => ['in_app', 'audit', 'email']],
            'deadline_extension_sciq_reviewed' => ['title' => 'Décision hiérarchique rendue', 'message' => 'Décision « {avis} » rendue sur la modification de l’action « {action_label} ».', 'channels' => ['in_app', 'audit', 'email']],
            'deadline_extension_dg_decided' => ['title' => 'Décision finale DG', 'message' => 'Décision « {decision} » sur la modification de l’action « {action_label} ».', 'channels' => ['in_app', 'audit', 'email']],
            // Titre dynamique selon l'event (submitted, approved, locked, reopened) — défaut côté service.
            'meeting_scheduled' => ['title' => 'Réunion programmée', 'message' => 'La réunion « {meeting_title} » est programmée le {meeting_date}.', 'channels' => ['in_app', 'audit', 'email']],
            'meeting_reminder' => ['title' => 'Rappel de réunion', 'message' => 'Rappel : la réunion « {meeting_title} » est prévue le {meeting_date}.', 'channels' => ['in_app', 'email']],
            'meeting_postponed' => ['title' => 'Réunion reportée', 'message' => 'La réunion « {meeting_title} » est reportée. Motif : {postponement_reason}', 'channels' => ['in_app', 'audit', 'email']],
            'meeting_cancelled' => ['title' => 'Réunion annulée', 'message' => 'La réunion « {meeting_title} » est annulée. Motif : {cancellation_reason}', 'channels' => ['in_app', 'audit', 'email']],
            'meeting_minutes_published' => ['title' => 'PV de réunion disponible', 'message' => 'Le procès-verbal de la réunion « {meeting_title} » est disponible dans votre espace documentaire.', 'channels' => ['in_app', 'audit', 'email']],
            'meeting_decision_assigned' => ['title' => 'Décision de réunion à suivre', 'message' => 'Une décision de réunion vous a été attribuée : {meeting_title}.', 'channels' => ['in_app', 'audit', 'email']],
