...
class AiPromptService
{
    ...
    public function ptaActionParameterizationPrompt(): string
    {
        return implode("\n", [
            ...
            'Tu dois proposer type_action parmi Q, NQ ou M apres lecture croisee de l action, de l objectif operationnel, du type d indicateur, de la quantite a realiser, des dates, des ressources et des risques.',
            ...
            'Ne jamais inventer une quantite a realiser : si elle est inconnue, mettre null et ajouter une alerte de validation humaine.',
    ...
    public function importGlobalColumnGuide(): array
    {
        return [
            ...
            'cible_minimum_execution' => 'seuil minimum en pourcentage, sans symbole %.',
            ...
            'quantite_cible' => 'quantite a realiser pour une action Q.',
            'unite_cible' => 'unite de mesure de la quantite a realiser.',
            'seuil_mode' => 'seuil unique ou trimestriel.',
